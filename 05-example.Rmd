...
### #2 - Create a histogram of the claims and comment on the shape (1 point)
...
### #3 - Fit a linear model (1 point)

```{r}
model = lm(claims ~ age + sex, data = data)
```

### #4 - Describe the relationship between age, sex, and claim costs (1 point)
...
### #5 - Write a summary of steps 1-4 in non-technical language (1 point)
