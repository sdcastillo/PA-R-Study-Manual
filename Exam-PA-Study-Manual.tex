...
\item
  Two \textbf{original} practice exams (coming soon)
\end{itemize}
...
\includegraphics{Exam-PA-Study-Manual_files/figure-latex/unnamed-chunk-74-1.pdf}
...
\includegraphics{Exam-PA-Study-Manual_files/figure-latex/unnamed-chunk-78-1.pdf}
...
\caption{\label{fig:unnamed-chunk-85}Residuals vs.~Fitted}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Exam-PA-Study-Manual_files/figure-latex/unnamed-chunk-86-1.pdf}
\caption{\label{fig:unnamed-chunk-86}Normal Q-Q}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{all_data <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ health_insurance, }\DataTypeTok{formula =}\NormalTok{ charges }\OperatorTok{~}\StringTok{ }\NormalTok{bmi }\OperatorTok{+}\StringTok{ }\NormalTok{age)}
\NormalTok{testing <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ test, }\DataTypeTok{formula =}\NormalTok{ charges }\OperatorTok{~}\StringTok{ }\NormalTok{bmi }\OperatorTok{+}\StringTok{ }\NormalTok{age)}
\end{Highlighting}
\end{Shaded}
...
\midrule
\endhead
(Intercept) & 1744.1 & 3920.4\tabularnewline
bmi & 51.4 & 115.4\tabularnewline
age & 22.3 & 48.8\tabularnewline
\bottomrule
\end{longtable}
...
\begin{figure}
\centering
\includegraphics{Exam-PA-Study-Manual_files/figure-latex/unnamed-chunk-90-1.pdf}
\caption{\label{fig:unnamed-chunk-90}Taking the log corrects for skewness}
\end{figure}
...
\begin{figure}
\includegraphics[width=22.32in]{images/glm_links} \caption{Distribution-Link Function Combinations}\label{fig:unnamed-chunk-91}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-98}Example of weak interaction}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Exam-PA-Study-Manual_files/figure-latex/unnamed-chunk-99-1.pdf}
\caption{\label{fig:unnamed-chunk-99}Example of strong interaction}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Exam-PA-Study-Manual_files/figure-latex/unnamed-chunk-101-1.pdf}
\caption{\label{fig:unnamed-chunk-101}Standard Logistic Function}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Exam-PA-Study-Manual_files/figure-latex/unnamed-chunk-105-1.pdf}
\caption{\label{fig:unnamed-chunk-105}Distribution of Predicted Probability}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Exam-PA-Study-Manual_files/figure-latex/unnamed-chunk-115-1.pdf}
\caption{\label{fig:unnamed-chunk-115}AUC for auto\_claim}
\end{figure}
...
\includegraphics{Exam-PA-Study-Manual_files/figure-latex/unnamed-chunk-117-1.pdf}
...
\includegraphics{Exam-PA-Study-Manual_files/figure-latex/unnamed-chunk-119-1.pdf}
...
\KeywordTok{library}\NormalTok{(caret)}
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{42}\NormalTok{)}
\NormalTok{index <-}\StringTok{ }\KeywordTok{createDataPartition}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ health_insurance}\OperatorTok{$}\NormalTok{charges, }\DataTypeTok{p =} \FloatTok{0.8}\NormalTok{, }\DataTypeTok{list =}\NormalTok{ F)}
\NormalTok{train <-}\StringTok{ }\NormalTok{health_insurance }\OperatorTok{%>%}\StringTok{ }\KeywordTok{slice}\NormalTok{(index)}
\NormalTok{test <-}\StringTok{ }\NormalTok{health_insurance }\OperatorTok{%>%}\StringTok{ }\KeywordTok{slice}\NormalTok{(}\OperatorTok{-}\NormalTok{index)}
...
\includegraphics{Exam-PA-Study-Manual_files/figure-latex/unnamed-chunk-124-1.pdf}
...
\includegraphics{Exam-PA-Study-Manual_files/figure-latex/unnamed-chunk-126-1.pdf}
...
\KeywordTok{library}\NormalTok{(caret)}
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{42}\NormalTok{)}
\NormalTok{index <-}\StringTok{ }\KeywordTok{createDataPartition}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ rf_data}\OperatorTok{$}\NormalTok{charges, }\DataTypeTok{p =} \FloatTok{0.8}\NormalTok{, }\DataTypeTok{list =}\NormalTok{ F)}
...
\includegraphics{Exam-PA-Study-Manual_files/figure-latex/unnamed-chunk-129-1.pdf}
...
\includegraphics{Exam-PA-Study-Manual_files/figure-latex/unnamed-chunk-131-1.pdf}
...
\NormalTok{bmi <-}\StringTok{ }\NormalTok{pdp}\OperatorTok{::}\KeywordTok{partial}\NormalTok{(rf, }\DataTypeTok{pred.var =} \StringTok{"bmi"}\NormalTok{, }\DataTypeTok{grid.resolution =} \DecValTok{20}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{autoplot}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_bw}\NormalTok{()}
\NormalTok{age <-}\StringTok{ }\NormalTok{pdp}\OperatorTok{::}\KeywordTok{partial}\NormalTok{(rf, }\DataTypeTok{pred.var =} \StringTok{"age"}\NormalTok{, }\DataTypeTok{grid.resolution =} \DecValTok{20}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{autoplot}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_bw}\NormalTok{()}
...
\begin{figure}
\centering
\includegraphics{Exam-PA-Study-Manual_files/figure-latex/unnamed-chunk-134-1.pdf}
\caption{\label{fig:unnamed-chunk-134}Partial Dependence}
\end{figure}
...
\KeywordTok{library}\NormalTok{(tidyverse)}
\KeywordTok{library}\NormalTok{(ExamPAData)}
\NormalTok{data <-}\StringTok{ }\NormalTok{health_insurance }\OperatorTok{%>%}\StringTok{ }
...
\begin{verbatim}
##       age            sex          claims     
##  Min.   :18.00   male  :676   Min.   : 1122  
##  1st Qu.:27.00   female:662   1st Qu.: 4740  
...
\includegraphics{Exam-PA-Study-Manual_files/figure-latex/unnamed-chunk-151-1.pdf}
