...
knitr::include_graphics(file.path(book_dir,"images/conditional_response.jpg"))
```
...
knitr::include_graphics(file.path(book_dir,"images/regression_metrics.png"))
```
...
```{r echo = F, fig.align="center", warning=F, out.width="800%"}
knitr::include_graphics(file.path(book_dir,"images/response_distributions.png"))
```
...
knitr::include_graphics(file.path(book_dir,"images/link_functions.png"))
```
...
knitr::include_graphics(file.path(book_dir,"images/discrete_link_functions.png"))
```
