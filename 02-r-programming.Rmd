...
<span style="color: blue;">**This is a communication exam **</span>  because 30-40% of the points are based on the quality of your writing and data storytelling.

The actuarial profession is no longer an Excel-only club.  You will need to build basic R programming skills.  The SOA will give you the complex codes, but you will need to write simple programs from scratch.  Prior to December 2020, you could depend on every possible syntax being provided in the Rmd template.  The most programming-intensive part is the data cleaning and visualization.  Subsequent questions on modeling will ask you to make changes to parameters and you can expect to use Excel for one or two questions to create tables of your results.

There is no need to memorize syntax.  You will have two cheat sheets for [data visualization](https://contentpreview.s3.us-east-2.amazonaws.com/Exam+PA+Spring+2021+Simplified+Data+Viz+Cheat+Sheet.pdf) and base R.  We have gone through and removed the parts that you will not need to learn.  You can use this in your study to become familiar with how to find the R code quickly. This cheat sheets that the SOA gives you were designed by the RStudio team for everyone who uses R. You do not need to use everything there. For example, no one will be making new types of ggplot graphs under the "graphical primatives" section and so this has been blocked out.  **Enroll in either of our online courses to get our simplified Base R cheat sheet and tutorial.**
...
A good attention to detail will carry you far. Expect to spend twice as long explaining what your code is doing as you do writing the code itself.  A few points are based on the organization of your .Rmd file, although you do not need this to read like an essay.  The vast majority of your time will be spent on your Word document.
...
This question is from the June 16, 2020 exam.  You can see that very only small code changes need to be made.  The remainder of this question consists of a short-answer response.  This is very typical of Exam PA.  
