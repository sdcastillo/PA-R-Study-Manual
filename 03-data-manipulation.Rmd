...
Data vocabulary is sloppy because many words mean the same thing.  *Cleaning*, *wrangling*, *manipulating*, and *ransforming* all describe the process making data easier to work with.  
